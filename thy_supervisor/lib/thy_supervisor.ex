defmodule ThySupervisor do
  ...
  def restart_child(supervior, pid, _child_spec) when is_pid(pid) do
    GenServer.call(supervior, {:restart_child, pid})
  end
  ...
  def which_childen(supervisor) do
    GenServer.call(supervisor, :which_childen)
  end
